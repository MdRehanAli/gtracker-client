...
const TermsAndConditions = () => {
    return (
        <div className="bg-white dark:bg-background-dark text-slate-900 dark:text-white font-display selection:bg-primary/30">
                ...
                <aside className="hidden lg:flex w-72 flex-col shrink-0 sticky top-24 h-fit">
                    <div className="flex flex-col gap-4 p-6 bg-slate-100 dark:bg-[#1f1a26] rounded-xl border border-slate-200 dark:border-[#302839]">
                        <div className="flex flex-col mb-2">
                            <h1 className="text-slate-900 dark:text-white text-lg font-bold leading-normal">Table of Contents</h1>
                    ...
                    <div className="flex flex-col gap-3 p-4 bg-slate-100 dark:bg-[#1f1a26] rounded-xl border border-slate-200 dark:border-[#302839]">
                        <div className="flex flex-wrap justify-between items-end gap-3">
                            <div className="flex flex-col gap-2">
                                <h1 className="text-slate-900 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Terms & Conditions</h1>
                    ...
                    <div className="bg-slate-100 dark:bg-[#1f1a26] border border-slate-200 dark:border-[#302839] rounded-xl p-6 md:p-10 space-y-10 shadow-xl shadow-black/20">
                        ...
                        <section className="scroll-mt-28" id="section-1">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">1. Acceptance of Terms</h2>
                            </div>
                            <p className="text-slate-700 dark:text-[#d1c9d8] text-base font-normal leading-relaxed">
                                By accessing and using the <span className="text-slate-900 dark:text-white font-semibold">Garment Order & Production Tracker System</span>, you agree to be bound by these legal terms. These terms constitute a legally binding agreement between you (the user) and the system administrator.
                            </p>
                        ...
                        <section className="scroll-mt-28" id="section-2">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">2. User Accounts</h2>
                            </div>
                        ...
                        <section className="scroll-mt-28" id="section-3">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">3. Product Listings & Orders</h2>
                            </div>
                            <p className="text-slate-700 dark:text-[#d1c9d8] text-base font-normal leading-relaxed">
                        ...
                        <section className="scroll-mt-28" id="section-4">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">4. Payment Terms</h2>
                            </div>
                        ...
                        <section className="scroll-mt-28" id="section-5">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">5. Intellectual Property</h2>
                            </div>
                            <p className="text-slate-700 dark:text-[#d1c9d8] text-base font-normal leading-relaxed">
                        ...
                        <section className="scroll-mt-28" id="section-6">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">6. Termination</h2>
                            </div>
                            <p className="text-slate-700 dark:text-[#d1c9d8] text-base font-normal leading-relaxed">
                        ...
                        <section className="scroll-mt-28" id="section-7">
                            <div className="flex items-center gap-4 mb-4 border-l-4 border-primary pl-4">
                                <h2 className="text-slate-900 dark:text-white tracking-tight text-2xl font-bold leading-tight">7. Limitation of Liability</h2>
                            </div>
