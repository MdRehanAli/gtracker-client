                ...
                <form onSubmit={handleSubmit(handleOrderSubmit)}>
                    <fieldset className="fieldset flex flex-col md:flex-row md:gap-10">
                        ...
                        <div className='flex-1'>
                            ...
                            <input type="email" {...register('email', { required: true })} className="input w-full text-primary border-primary" placeholder="Email" defaultValue={user?.email} readOnly />
                            {errors.email?.type === "required" && <p className='text-red-500'>Email is Required</p>}

                            {/* Product Title Field  */}
                            <label className="label text-primary mt-2">Product Title</label>
                            <input type="text" {...register('productTitle', { required: true })} className="input w-full text-primary border-primary" placeholder="Name" defaultValue={name} readOnly />
                            ...
                            <input type="text" {...register('price', { required: true })} className="input w-full text-primary border-primary" placeholder="Price" defaultValue={price} readOnly />
                            ...
                            <input type="text" {...register('firstName', { required: true, minLength: 3 })} className="input w-full text-primary border-primary" placeholder="First Name" />
                            ...
                            <input type="text" {...register('lastName', { required: true, minLength: 3 })} className="input w-full text-primary border-primary" placeholder="Last Name" />
                        ...
                        <div className='flex-1'>
                            ...
                            <input type="number" {...register('orderQuantity', {
                                ...
                                className="input w-full text-primary border-primary" placeholder="Order Quantity" />
                            ...
                            <input type="number" {...register('contactNumber', { required: true, minLength: 11 })} className="input w-full text-primary border-primary" placeholder="Contact Number" />
                            ...
                            <input type="text" {...register('deliveryAddress', { required: true, })} className="input w-full text-primary border-primary" placeholder="Delivery Address" />
                            ...
                            <input type="text" {...register('instructions', { required: true, })} className="input w-full text-primary border-primary" placeholder="Additional Notes/Instructions" />
