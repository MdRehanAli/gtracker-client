                ...
                <div className='mb-12 text-center'>
                    <FlyInMotion index={1}>
                        <div className='flex justify-center items-center gap-2 mb-5'>
                            ...
                            <div>
                                <h1 className='text-3xl md:text-4xl font-bold text-primary text-nowrap'>Digital Fabric</h1>
                                <div className='h-px w-20 md:w-26 bg-primary flex mx-auto animate-[ping_3s_linear_infinite] hover:animate-none'></div>
                            </div>
                        </div>
                    </FlyInMotion>
                    <FlyInMotion index={3}>
