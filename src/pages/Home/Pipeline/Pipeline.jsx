...
const Pipeline = () => {
    return (
        <section className="my-20 py-24 bg-accent relative mx-auto max-w-7xl w-11/12 rounded-xl">
            <div className=" px-8 relative z-10">
                <h2 className="text-4xl font-black text-center mb-20 text-accent">The Deployment Pipeline</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        <div className="text-8xl font-black text-primary/10 absolute -top-4 -left-2">01</div>
                        <div className="relative">
                            <h4 className="text-xl font-bold text-accent mb-4">Tech Pack Audit</h4>
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        ...
                        <div className="relative">
                            <h4 className="text-xl font-bold text-accent mb-4">IoT Integration</h4>
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        ...
                        <div className="relative">
                            <h4 className="text-xl font-bold text-accent mb-4">Machine Sewing</h4>
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        ...
                        <div className="relative">
                            <h4 className="text-xl font-bold text-accent mb-4">Final Validation</h4>
