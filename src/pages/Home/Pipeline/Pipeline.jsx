...
const Pipeline = () => {
    return (
        <section className="my-20 bg-accent relative mx-auto max-w-7xl w-11/12 rounded-xl">
            <div className="lg:p-20 md:p-10 p-5 py-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        <div className="text-8xl  text-primary/10 absolute -top-2 -left-1">01</div>
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        <div className="text-8xl  text-primary/10 absolute -top-2 -left-1">02</div>
                        <div className="relative">
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        <div className="text-8xl  text-primary/10 absolute -top-2 -left-1">03</div>
                        <div className="relative">
                    ...
                    <div className="relative p-10 bg-slate-50 dark:bg-slate-800 rounded-xl border border-primary">
                        <div className="text-8xl  text-primary/10 absolute -top-2 -left-1">04</div>
                        <div className="relative">
