...
const Join = () => {
    return (
        <section className="my-20 py-24 bg-slate-50 dark:bg-slate-800 mx-auto max-w-7xl w-11/12 rounded-xl">
            <div className=" px-8">
                <div className="bg-gradient-to-r from-primary/30 to-slate-900 dark:to-slate-900 p-12 rounded-xl border border-primary/20 flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <form className="flex w-full lg:max-w-md gap-4">
                        <input
                            className="w-full bg-slate-900 border border-white/10 rounded-xl px-6 py-4 focus:border-primary focus:ring-primary text-white placeholder-slate-400"
