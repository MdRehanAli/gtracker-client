            ...
            <div className='bg-no-repeat bg-cover' style={{ backgroundImage: `url(${statistics})` }}>
                <div className=' min-h-[500px] p-5 md:p-20 bg-accent/80 text-white text-center flex flex-col items-center justify-center gap-2'>
                    ...
                    <div className='md:w-2/3'>
                        <FlyInMotion index={1}>
                            <p className='my-5 text-secondary'>GTracker is the world best software services for Garment Order & Production Tracker for small and medium factories. Reduce delays manage workflow from cutting to delivery.</p>
                        </FlyInMotion>
                    </div>
                    <FlyInMotion index={1}>
