        ...
        <section className="my-20 bg-accent mx-auto max-w-7xl w-11/12 rounded-xl">
            <div className="lg:p-20 md:p-10 p-5 py-10">
                <div className='mb-12 text-center'>
                    <FlyInMotion index={1}>
                        <div className='flex justify-center items-center gap-2 mb-5'>
                            ...
                            <div>
                                <h1 className='text-3xl md:text-4xl font-bold text-primary text-nowrap'>Winter Showcase</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <FlyInMotion index={4}>
                        <div className="aspect-3/4 animate-[pulse_2s_linear_infinite] hover:animate-none rounded-xl overflow-hidden">
                            <img
                                alt="Lookbook"
                    ...
                    <FlyInMotion index={5}>
                        <div className="aspect-3/4 animate-[pulse_3s_linear_infinite] hover:animate-none rounded-xl overflow-hidden lg:mt-12">
                            <img
                                alt="Lookbook"
                                className="w-full h-full object-cover"
