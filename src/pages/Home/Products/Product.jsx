...
const Product = ({ product }) => {
    ...
    return (
        <div className="flex flex-col rounded-xl group transition-all hover:scale-105 duration-200  bg-accent border border-primary/50 hover:border-primary hover:shadow-lg hover:shadow-primary/10">
