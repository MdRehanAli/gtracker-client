...
const Services = () => {
    return (
        <section className="py-24 bg-accent mx-auto max-w-7xl w-11/12 rounded-xl">
            <div className=" px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="p-10 rounded-xl bg-slate-50 dark:bg-slate-800 border border-primary hover:border-primary dark:hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all hover:-translate-y-2">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-accent">OEM Solutions</h4>
                    ...
                    <div className="p-10 rounded-xl bg-slate-50 dark:bg-slate-800 border border-primary hover:border-primary dark:hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all hover:-translate-y-2">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-accent">ODM Design</h4>
                    ...
                    <div className="p-10 rounded-xl bg-slate-50 dark:bg-slate-800 border border-primary hover:border-primary dark:hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all hover:-translate-y-2">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-accent">Private Label</h4>
                    ...
                    <div className="p-10 rounded-xl bg-slate-50 dark:bg-slate-800 border border-primary hover:border-primary dark:hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all hover:-translate-y-2">
                        ...
                        <h4 className="text-xl font-bold mb-4 text-accent">DTC Fulfillment</h4>
