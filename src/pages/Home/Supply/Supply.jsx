    ...
    return (
        <section className="my-20 mx-auto max-w-7xl w-11/12">
                <div className="mb-12 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold">Supply Chain Ecosystem</h2>
                    <p className="text-slate-600 dark:text-slate-400 mt-3 text-lg">Four pillars of modern garment manufacturing intelligence.</p>
                </div>
