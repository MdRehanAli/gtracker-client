        ...
        <section className="my-20 mx-auto max-w-7xl w-11/12">
            <div className="mb-12 text-center">
                <div className='flex justify-center items-center gap-2 mb-5'>
                    ...
                    <h1 className='text-3xl md:text-4xl font-bold text-primary'>Supply Chain Ecosystem</h1>
                </div>
                <p className="text-secondary mt-3 text-lg">Four pillars of modern garment manufacturing intelligence.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="p-5 md:p-10 rounded-xl bg-accent border border-primary hover:border-primary dark:hover:border-primary hover:shadow-lg hover:shadow-primary/10 transform duration-200 hover:scale-105">
