            ...
            <div className=' shadow-xl bg-linear-to-r from-primary/30 to-accent rounded-xl py-10 p-5 md:p-10 '>
                <div className="mb-12 text-center">
                    <div className='flex justify-center items-center gap-2'>
                        ...
                        <h1 className='text-3xl md:text-4xl font-bold text-primary'>Update Product</h1>
                    </div>
                </div>
                <form onSubmit={handleSubmit(handleUpdateProduct)}>
                    <fieldset className="fieldset flex flex-col md:flex-row md:gap-10">
                        ...
                        <div className='flex-1'>
                            ...
                            <input type="text" {...register('name', { required: true })} defaultValue={name} className="input w-full border border-primary bg-accent outline-primary text-primary" placeholder="Product Name" />
                            ...
                            <textarea rows={4} placeholder="Product Description" className='p-3 w-full border border-primary ou rounded-sm text-sm bg-accent outline-primary text-primary' name="" {...register('largeDescription', { required: true })} defaultValue={largeDescription} id=""></textarea>
                            {errors.largeDescription?.type === "required" && <p className='text-red-500'>Product Description is Required</p>}

                            {/* Category Field  */}
                            <label className=" label mt-2 text-primary">Select Category</label>
                            <select {...register('category', { required: true })} defaultValue={category} className="select w-full border border-primary bg-accent outline-primary text-primary">
                            ...
                            <input type="number" {...register('price', { required: true })} defaultValue={price} className="input w-full border border-primary bg-accent outline-primary text-primary" placeholder="Price" />
                        ...
                        <div className='flex-1'>
                            ...
                            <input type="number" {...register('availableQuantity', { required: true })} defaultValue={availableQuantity} className="input w-full border border-primary bg-accent outline-primary text-primary" placeholder="Available Quantity" />
                            ...
                            <input type="number" {...register('minimumOrder', { required: true })} defaultValue={minimumOrder} className="input w-full border border-primary bg-accent outline-primary text-primary" placeholder="Minimum Order Quantity (MOQ)" />
                            ...
                            <input type="text" {...register('video')} defaultValue={video} className="input w-full border border-primary bg-accent outline-primary text-primary" placeholder="Demo Video Link" />

                            {/* Payment Options Field  */}
                            <label className=" label mt-2 text-primary">Payment Options</label>
                            <select {...register('paymentOptions', { required: true })} defaultValue={paymentOptions} className="select w-full border border-primary bg-accent outline-primary text-primary">
